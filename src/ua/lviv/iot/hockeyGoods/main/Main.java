...
public class Main {
	...
	public static void main(String[] args) {
		...
		IceSkates oldSkates = new IceSkates(250, "No Data", Age.KID, ProfessionalLevel.AMATEUR, PlayerType.FIELDPLAYER,
				badRate, 37, "Vapor X300");
		...
		Protection protectionForLegs = new Protection(575, "Just Professional", Age.SENIOR,
				ProfessionalLevel.PROFESSIONAL, superRate, ProtectionType.GLOVES, PlayerType.GOALKEEPER, "Plastic");
		Protection helmet = new Protection(850, "Strong For Strong", Age.JUNIOR, ProfessionalLevel.HALFPROFESSIONAL,
				badRate, ProtectionType.HELMET, PlayerType.FIELDPLAYER, "Plastic");

		Stick woodStick = new Stick(950, "Wood Legend", Age.SENIOR, ProfessionalLevel.HALFPROFESSIONAL, goodRate,
				"Wood", PlayerType.GOALKEEPER, 1.3);
		...
		List<HockeyGood> sortedByRatingList = manager.sortByRating(manager.getHockeyGoodsList(), SortingWay.DESCENDING);
		sortedByRatingList.forEach((good) -> System.out.println(good));

		System.out.println("Filtered List of Goods:\n");
		List<HockeyGood> goalKeeperPlayerList = manager.filterByPlayerType(manager.getHockeyGoodsList(),
